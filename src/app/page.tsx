...
import GrowthEstimatorSection from '@/components/GrowthEstimatorSection';
                        ...
                        <div className="inner">
                            ...
                            <h1 className="title tmp-scroll-trigger tmp-fade-in animation-order-2">
                                ...
                                <span className="header-caption">
                                    <HeroInteractive roles={hero.rotatingRoles && hero.rotatingRoles.length > 0 ? hero.rotatingRoles : ['Digital Marketer', 'Growth Strategist', 'Meta Ads Specialist', 'Google Ads Buyer', 'CAPI & Tracking Pro']} />
                                </span>
                            </h1>
                            <p className="disc tmp-scroll-trigger tmp-fade-in animation-order-3">{hero.description || profile.sidebarBio}
                            </p>
                            <div style={{ display: 'flex', flexWrap: 'wrap', gap: '8px', marginTop: '18px', marginBottom: '24px' }}>
                                <span style={{ fontSize: '12px', fontWeight: 700, padding: '6px 14px', borderRadius: '500px', backgroundColor: 'rgba(19, 155, 253, 0.12)', border: '1px solid rgba(19, 155, 253, 0.3)', color: '#42AFFD' }}>
                                    ⭐ 10+ Years Experience
                                </span>
                                <span style={{ fontSize: '12px', fontWeight: 700, padding: '6px 14px', borderRadius: '500px', backgroundColor: 'rgba(0, 230, 118, 0.12)', border: '1px solid rgba(0, 230, 118, 0.3)', color: '#00E676' }}>
                                    📈 $1M+ Ad Spend Managed
                                </span>
                                <span style={{ fontSize: '12px', fontWeight: 700, padding: '6px 14px', borderRadius: '500px', backgroundColor: 'rgba(255, 170, 0, 0.12)', border: '1px solid rgba(255, 170, 0, 0.3)', color: '#FFAA00' }}>
                                    🎯 4.8x Avg ROAS
                                </span>
                                <span style={{ fontSize: '12px', fontWeight: 700, padding: '6px 14px', borderRadius: '500px', backgroundColor: 'rgba(255, 255, 255, 0.08)', border: '1px solid rgba(255, 255, 255, 0.15)', color: '#FFFFFF' }}>
                                    📍 Phnom Penh, Cambodia
                                </span>
                            </div>
