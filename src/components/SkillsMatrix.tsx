...
export default function SkillsMatrix() {
  const skillCategories = [
    ...
    {
      category: 'Web Development & Modern Tech',
      icon: Code,
      color: 'cyan',
      skills: [
        { name: 'Next.js & React Applications', level: 'Advanced (85%)' },
        { name: 'WordPress Architecture & Themes', level: 'Expert (95%)' },
        { name: 'HTML5, Modern CSS, Tailwind CSS', level: 'Expert (95%)' },
        { name: 'JavaScript & Modern TypeScript', level: 'Advanced (85%)' },
        { name: 'Responsive Mobile-First UI/UX', level: 'Expert (94%)' },
        { name: 'Technical On-Page & Schema SEO', level: 'Advanced (90%)' },
      ],
    },
    {
      category: 'IT Infrastructure & Hosting Management',
      icon: Server,
      color: 'teal',
      skills: [
        { name: 'cPanel & WHM Server Administration', level: 'Expert (95%)' },
        { name: 'Domain Management & DNS Routing', level: 'Expert (95%)' },
        { name: 'SSL Configuration & Web Hardening', level: 'Advanced (90%)' },
        { name: 'Corporate Email & MX Records', level: 'Expert (92%)' },
        { name: 'Cloudflare CDN & Security Rules', level: 'Advanced (88%)' },
        { name: 'Database & Website Backup Systems', level: 'Expert (92%)' },
      ],
    },
    {
